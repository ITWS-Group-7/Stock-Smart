      ...
      <div class="col-sm-2" id="hvr-float-shadow">
        ...
        <div class="card " style = "border-radius: 10%; border-color: white;    " >
          ...
          <div class="card-body">
            ...
            <a href=" stocksmart.php?action=dairy" class="btn btn-primary food_group" id = "food_group_dairy">DAIRY</a>
          </div>
        </div>
      </div>
      <div class="col-sm-2" id="hvr-float-shadow">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class = "table_footer pb-5">
        ...
        <button type="button" class="btn add_item" data-toggle="modal" data-target="#item_modal" id="hvr-curl-top-right">ADD ITEM</button>
