<html>
  ...
  <body>
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class = "signup_login">
                  <a href="./signup.html" class="btn btn-primary signup" id="hvr-grow-shadow">Sign Up</a>
                  <a href="./login.html" class="btn btn-primary login" id="hvr-grow-shadow" >Login</a>
                </div>
    ...
    <div class="container">
      ...
      <div class="container">
          <button type="button" class="btn btn-dark float-right" data-toggle="modal" data-target="#exampleModal" id="bhvr-curl-top-right">
            Add to Grocery List
          </button>
        <!-- Modal -->
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="stocksmart.php" method="POST">
                        <div class="form-group">
                          <label for="food">Food</label>
                          <input class="form-control" type="text" name="food" placeholder="Input food item">
                        </div>
                        <div class="form-group">
                            <label for="food-group">Food Group</label>
                            <input class="form-control" type="text" name="foodgroup" placeholder="Input food group">
                            <small id="emailHelp" class="form-text text-muted">Food group options are fruits, vegetables, grains, or proteins</small>
                          </div>
                        <div class="form-check">
                          <input type="checkbox" name="bought" class="form-check-input" id="exampleCheck1">
                ...
                <button type="submit" class="btn btn-dark" name="insert_grocery">Submit</button>
                </div>
            </div>
            </div>
        </div>
